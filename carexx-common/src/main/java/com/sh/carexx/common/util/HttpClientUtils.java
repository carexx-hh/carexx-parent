...
public final class HttpClientUtils {
    ...
    /**
     * Function:提现时带上证书发送post请求, 指定编码<br/>
     * Condition:TODO <br/>
     * Notice:TODO <br/>
     ...
     * @since JDK 1.7
     */
    public static String doRefund(String url, Map<String, String> headers, String body, String passWord, String charset)
            throws Exception {
        HttpPost post = new HttpPost(url);
        if (headers != null && headers.size() > 0) {
            for (Map.Entry<String, String> entry : headers.entrySet()) {
        ...
        FileInputStream instream = new FileInputStream(new File("apiclient_cert.p12"));//P12文件目录
        try {
